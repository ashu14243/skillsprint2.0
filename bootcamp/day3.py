...
#     pass
#
# cv2.createTrackbar("threshold1","parameter",100,255,empty)
# cv2.createTrackbar("threshold2","parameter",200,255,empty)
# def get_contour(img_dilate,img_contours):
...
#     output=np.hstack([img_grey,img_dilate])
#     #output=np.hstack([img,img_blur])
