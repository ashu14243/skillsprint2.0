...
# while True:
#     ret,frame = cap.read()   #ret gives true or false frame jiss area pey hmmlog study kar rahe hai kitna jagah pey kaam hai baas wahi
#
...
# # cv2.line(img, (starting coordinate), (ending coordinate), (color of line), (thickness of line))
...
while True:
    ret, frame = cap.read()   #cap open hua toh true nhi tohh false
    date_time=str(dt.datetime.now())
    cv2.putText(frame,"ASHUTOSH KUMAR",(100,150),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,255),2)
